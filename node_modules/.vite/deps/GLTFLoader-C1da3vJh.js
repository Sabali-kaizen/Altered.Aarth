import { $i as PointLight, Ao as Skeleton, B as BufferAttribute, Dr as LinearFilter, Er as LineSegments, Fs as Vector3, Gi as OrthographicCamera, Gn as InstancedMesh, Hn as InstancedBufferAttribute, I as Box3, Ir as Loader, Kr as MathUtils, Ln as ImageBitmapLoader, Lr as LoaderUtils, Ls as VectorKeyframeTrack, Mo as SkinnedMesh, Mr as LinearMipmapNearestFilter, N as Bone, Ni as NumberKeyframeTrack, Nr as LinearSRGBColorSpace, Pi as Object3D, Po as Sphere, Ps as Vector2, Q as ClampToEdgeWrapping, Qn as Interpolant, Qr as MeshBasicMaterial, Tr as LineLoop, Ur as Material, V as BufferGeometry, Wt as DirectionalLight, Xn as InterleavedBuffer, Yi as PerspectiveCamera, Yr as Matrix4, Zn as InterleavedBufferAttribute, Zr as Mesh, _i as NearestMipmapNearestFilter, ai as MeshPhysicalMaterial, as as Texture, bo as SRGBColorSpace, da as QuaternionKeyframeTrack, dn as FileLoader, do as RepeatWrapping, er as InterpolateDiscrete, et as Color, gi as NearestMipmapLinearFilter, h as AnimationMixer, jn as Group, jo as SkeletonHelper, jr as LinearMipmapLinearFilter, li as MirroredRepeatWrapping, na as PointsMaterial, nt as ColorManagement, oa as PropertyBinding, oi as MeshStandardMaterial, os as TextureLoader, p as AnimationClip, pi as NearestFilter, pn as Float32BufferAttribute, ta as Points, tr as InterpolateLinear, ua as Quaternion, xr as LineBasicMaterial, yr as Line, zo as SpotLight } from "./three.core-DPcxE3-y.js";
...
function deinterleaveAttribute(attribute) {
	...
	let newAttribute;
	if (attribute.isInstancedInterleavedBufferAttribute) newAttribute = new InstancedBufferAttribute(array, itemSize, normalized, attribute.meshPerAttribute);
	else newAttribute = new BufferAttribute(array, itemSize, normalized);
...
function computeMorphedAttributes(object) {
	...
	} else if (Array.isArray(material)) for (i = 0, il = groups.length; i < il; i++) {
		group = groups[i];
		start = Math.max(group.start, drawRange.start);
		end = Math.min(group.start + group.count, drawRange.start + drawRange.count);
		for (j = start, jl = end; j < jl; j += 3) {
...
function toCreasedNormals(geometry, creaseAngle = Math.PI / 3) {
	...
	let positions;
	if (posAttr.isBufferAttribute === true && posAttr.itemSize === 3 && posAttr.normalized === false) positions = posAttr.array;
	else {
...
var SkeletonUtils_exports = /* @__PURE__ */ __exportAll({
	clone: () => clone,
	retarget: () => retarget,
...
//#endregion
export { deepCloneAttribute as a, mergeVertices as c, BufferGeometryUtils_exports as i, __exportAll as l, SkeletonUtils_exports as n, mergeGeometries as o, clone as r, mergeGroups as s, GLTFLoader as t };
